...
It is important to note that this trend appears quadratic rather than linear. Now, let us check for appproximate normality among our variables.
...
The data do not appear to follow a normal distribution. We can check if this is improved by using a transformation on our data, but note that this will make interpretability much more difficult.
